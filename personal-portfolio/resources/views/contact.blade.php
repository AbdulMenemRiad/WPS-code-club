                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light rounded p-5 h-100 shadow-sm">
                        ...
                        <p class="mb-4 text-muted">
                            {{ __('Whether you have a question about my Arduino builds, want to see more of my Laravel backend code, or want to reach out regarding Fall 2026 admissions, drop me a message below.') }}
                        </p>

                        @if (session('success'))
                            <div class="alert alert-success">{{ session('success') }}</div>
                        @endif
                        <form action="{{ url('/contact/submit') }}" method="POST"> @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-white border-0" id="subject"
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-white border-0" placeholder="{{ __('Message') }}" id="message" name="message"
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="rounded overflow-hidden shadow-sm flex-grow-1" style="min-height: 250px;">
                            <iframe class="w-100 h-100"
                                ...
                                style="border:0; filter: grayscale(80%) contrast(120%);" allowfullscreen="" loading="lazy"
