      ...
      <div class="container py-5">
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.3s">
            ...
            <p class="fs-5 mb-4">
              I am a web developer and mechatronics enthusiast driven by a passion for building robust systems. Whether I am writing Laravel backends for clients, configuring servers on Fedora Linux, or wiring up Arduino circuits, I love tackling complex technical challenges.
            </p>
            <p class="mb-4 text-muted">
              My portfolio spans from high-level software development to low-level hardware integration. Check out my featured projects below to see my code and circuitry in action.
            </p>
            <div class="d-flex gap-3">
                <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="{{ url('/about') }}">Read Full Story</a>
                <a class="btn btn-outline-primary rounded-pill py-3 px-5" href="{{ asset('resume.pdf') }}" target="_blank"><i class="fas fa-download me-2"></i>Download CV</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4 fs-5">Words and code snippets only tell half the story. Watch my recent artificial intelligence and hardware integrations in real-time.</p>
                    <ul class="list-unstyled mb-4 fs-5">
                        <li class="mb-2"><i class="fas fa-check-circle text-primary me-3"></i>Computer Vision tracking</li>
                        <li class="mb-2"><i class="fas fa-check-circle text-primary me-3"></i>Real-time robotic actuations</li>
                        <li class="mb-2"><i class="fas fa-check-circle text-primary me-3"></i>Custom Arduino logic</li>
                    </ul>
                    <a href="{{ url('/projects') }}" class="btn btn-primary rounded-pill py-3 px-5">Explore All Hardware</a>
                </div>
